...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/FrontendBundle/Entity')));
        ...
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'FrontendBundle' => 'FrontendBundle\\Entity'));
